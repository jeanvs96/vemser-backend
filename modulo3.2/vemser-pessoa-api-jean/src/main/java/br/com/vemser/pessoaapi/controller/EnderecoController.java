...
public class EnderecoController {
    ...
    public ResponseEntity<List<EnderecoEntity>> enderecoByPais(@RequestParam String pais) {
        return new ResponseEntity<>(enderecoRepository.enderecoByPais(pais), HttpStatus.OK);
    }

    @GetMapping("/endereco-por-idpessoa")
    public ResponseEntity<List<EnderecoEntity>> enderecoByPais(@RequestParam Integer idPessoa) {
        return new ResponseEntity<>(enderecoRepository.enderecoByIdPessoa(idPessoa), HttpStatus.OK);
    }
}
